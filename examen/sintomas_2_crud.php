                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="hidden" id="workPage"         name="workPage"         value="sintomas_2_crud.php?competicion=<?php echo $valorCompeticion; ?>&encuentro=<?php echo $valorEncuentro; ?>&" required readonly>
