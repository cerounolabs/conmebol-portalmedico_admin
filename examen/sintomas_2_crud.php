<?php
    ...
    $equipoJSON     = get_curl('200/competicion/equipo/alta/'.$usu_04.'/'.$valorCompeticion.'/206');
?>
...
?>
                                                <div class="col-sm-12 col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <label for="var1052_<?php echo $indSerolgia; ?>"> S&Iacute;NTOMAS <?php echo $dominioVALUE['tipo_nombre_castellano']; ?> </label>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="form-group">
                                        ...
                                        <input id="workPage" name="workPage" class="form-control" type="hidden" placeholder="Modo" value="sintomas_2_crud.php?competicion=<?php echo $valorCompeticion; ?>&encuentro=<?php echo $valorEncuentro; ?>&" required readonly>
