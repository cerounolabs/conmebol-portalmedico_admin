                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="hidden" id="workPage"         name="workPage"         value="covid19_1_crud.php?competicion=<?php echo $valorCompeticion; ?>&encuentro=<?php echo $valorEncuentro; ?>&" required readonly>
