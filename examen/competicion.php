                            ...
                            <div class="col-md-2">
                                <div class="card" style="height:200px; padding:20px;">
                                    <a href="../examen/encuentro.php?competicion=<?php echo $competicionVALUE['competicion_codigo']; ?>" style="height:100%">
                                        <img class="card-img-top img-responsive" src="../<?php echo $competicionVALUE['competicion_imagen_path']; ?>" alt="<?php echo $competicionVALUE['competicion_nombre']; ?>" title="<?php echo $competicionVALUE['competicion_nombre']; ?>" style="height:100%">
                                    </a>
                                </div>
                            </div>
<?php
