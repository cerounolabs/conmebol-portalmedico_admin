$(document).ready(function() {
	var xDATA       = getExamenPrueba(210, _codEncu, _codEqui);
...
function setExamenCovid(codElem, codAcc){
	var xJSON       = getExamenPrueba(210, _codEncu, _codEqui);
	var html        = '';
	var bodyCol     = '';
	var bodyTit     = '';
	var bodyMod     = '';
			...
			xJSON.forEach(element => {
				if (element.examen_codigo == codElem) {
					html = 
						...
						'   <form id="form" data-parsley-validate method="post" enctype="multipart/form-data" action="../class/crud/precompeticion_estado_crud.php">'+
						...
						'               <input class="form-control" type="hidden" id="workPage"		name="workPage"		value="precompeticion.php?competicion='+ _codComp +'&equipo='+ _codEqui +'&" required readonly>'+
