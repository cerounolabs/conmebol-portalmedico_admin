...
?>
            ...
            <div class="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <!-- ============================================================== -->
                    <!-- row -->
                    <form method="post" action="../class/crud/covid19.php" class="validation-wizard wizard-circle m-t-40">
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body" style="">
                                        ...
                                        <a role="button" class="btn btn-dark" href="../public/covid19.php?"> Volver </a>
                                    </div>
                                </div>
                            </div>
                        </div>
