                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                ...
                                <a class="dropdown-item" href="javascript:void(0)" data-toggle="modal" data-target="#modaldiv" onclick="setChangeCont('<?php echo $log_04; ?>', '<?php echo $log_02; ?>', '<?php echo $log_01; ?>', 'public/home');">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
							...
							<ul aria-expanded="false" class="collapse first-level">
                            	<li class="sidebar-item">
                               		<a href="../public/medico.php?codigo=1" class="sidebar-link">
                                ...
                                <li class="sidebar-item">
                               		<a href="../public/medico.php?codigo=2" class="sidebar-link">
